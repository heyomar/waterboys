<?php get_header(); ?>
  <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    <div class="wb__page-hero gp__page-hero">
      <h2 class="st__title textured">Groups<br><img class="st__title-wave" src="<?php echo get_stylesheet_directory_uri() ?>/assets/wb__home-wave.png" alt=""></h2>
    </div>
...
<div class="gr__ctn">
  <p class="gr__head-copy">
    ...
    Now you can get in the action by starting your own fundraising group. Recruit your family, friends, neighbors, colleagues and social networks to build a team. Set your group’s fundraising goal, engage your members, create a challenge and have some fun for a good cause!<br><br>
